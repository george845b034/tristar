...
class Flasks_list extends CI_Controller
{
	...
	private function getList()
	{
		...
		$result['result'] = $this->plants_list_model->getListContent(1, $start, $limit, $sortId, $sort);
	...
	**/
	private function getPage()
	{
		...
		{	
			...
			$count = $this->plants_list_model->getListBasic(1);
		}
		$tempArray = Array(
	...
	**/
	private function view_page($inData)
	{
		...
		$this->load->view('flasks_list', $inData);
